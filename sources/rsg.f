...
c     .......... find eigenvalues only ..........
      call  gtred1(nm,n,a,w,fv1,fv2)
      call  tqlrat(n,w,fv2,ierr)
      go to 50
c     .......... find both eigenvalues and eigenvectors ..........
   20 call  gtred2(nm,n,a,w,fv1,z)
      call  gtql2(nm,n,w,fv1,z,ierr)
      if (ierr .ne. 0) go to 50
...
c
      ...
      double precision b,c,f,g,h,p,r,s,t,epslon,gpythag
c
...
c                eigenvalue after 30 iterations ..........
 ...
 1001 return
      ...
      double precision function gpythag(a,b)
...
c     .......... set error -- b is not positive definite ..........
 ...
 1001 return
      ...
      subroutine gtql2(nm,n,d,e,z,ierr)
c
      integer i,j,k,l,m,n,ii,l1,l2,nm,mml,ierr
      double precision d(n),e(n),z(nm,n)
      double precision c,c2,c3,dl1,el1,f,g,h,p,r,s,s2,tst1,tst2,gpythag
c
...
c                eigenvalue after 30 iterations ..........
 ...
 1001 return
      ...
      subroutine gtred1(nm,n,a,d,e,e2)
c
...
c
      ...
      subroutine gtred2(nm,n,a,d,e,z)
c
      integer i,j,k,l,n,ii,nm,jp1
